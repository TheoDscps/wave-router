...
internal static class AppStrings
{
    public static readonly Dictionary<string, string> French = new()
    {
        ...
        ["MainWindow.ExecutableWildcardHint"] = "Accepte * (n'importe quelle suite de caractères) et ? (un seul caractère), ex. \"chrome*\"",
    ...
    public static readonly Dictionary<string, string> English = new()
    {
        ...
        ["MainWindow.ExecutableWildcardHint"] = "Accepts * (any run of characters) and ? (a single character), e.g. \"chrome*\"",
